  ...
  <div id="kisanWindow">
    <div class="kw-header">
      ...
      <div style="display:flex;align-items:center;gap:8px">
        <button class="kw-icon-btn" id="kisanHistoryBtn" onclick="toggleKisanHistory()" title="Chat History">
          <i class="fas fa-history"></i>
        </button>
        <button class="kw-icon-btn" onclick="shareKisanChat()" title="Share Chat">
    ...
    <div id="kisanHistoryPanel" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0;z-index:10;background:var(--card,#111a12);flex-direction:column;">
      <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;background:linear-gradient(135deg,#166534,#15803d);flex-shrink:0">
        <div style="display:flex;align-items:center;gap:10px">
          ...
          <div>
            <div style="font-weight:700;font-size:.92rem;color:#fff">Chat History</div>
            <div style="font-size:.68rem;color:rgba(255,255,255,.7)">This session only • Clears on close</div>
          </div>
        </div>
        <div style="display:flex;gap:8px">
          <button class="kw-icon-btn" onclick="clearKisanHistory()" title="Clear All"><i class="fas fa-trash"></i></button>
          <button class="kw-icon-btn" onclick="toggleKisanHistory()" title="Back"><i class="fas fa-arrow-left"></i></button>
        </div>
      </div>
